    ...
    <div class="page">
        <div class="page-header h-300 mb-30">
            <div class="text-center blue-grey-800 m-0 mt-50">
                <div class="font-size-50 mb-30 blue-grey-800">Welcome {{ auth()->user()->employee_code }}</div>
                    ...
                    <div class="card card-shadow">
                        <div class="card-block text-center bg-white p-40">
                            <div class="avatar avatar-100 mb-20">
                                <img src="{{ asset('backend/global/portraits/1.jpg') }}" alt="">
                            </div>
                        ...
                        <div class="card-block p-30" style="min-width:480px;">
                            ...
                            <ul class="list-inline text-center mb-0">
                                ...
                                <li class="list-inline-item ml-35">
                                    <i class="icon wb-large-point teal-200 mr-10" aria-hidden="true"></i> MOBILE
                                    PHONE
                                </li>
                            </ul>
                        </div>
                                        ...
                                        <div class="counter-label">
                                            <div class="progress progress-xs mb-10 bg-blue-800">
                                                <div class="progress-bar progress-bar-info bg-white" style="width: 42%"
                                                    aria-valuemax="100" aria-valuemin="0" aria-valuenow="42"
                                                    role="progressbar">
                                            ...
                                            <div class="counter counter-sm text-left">
                                                <div class="counter-number-group">
                                                    ...
                                                    <span class="counter-number-related font-size-14">HIGHER THAN LAST
                                                        MONTH</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="counter-label">
                                            <div class="progress progress-xs mb-10 bg-red-800">
                                                <div class="progress-bar progress-bar-info bg-white" style="width: 70%"
                                                    aria-valuemax="100" aria-valuemin="0" aria-valuenow="70"
                                                    role="progressbar">
                    ...
                    <div class="panel" id="followers">
                        <div class="panel-heading">
                            ...
                            <div class="panel-actions panel-actions-keep">
                                <div class="dropdown">
                                    <a class="panel-action" id="examplePanelDropdown" data-toggle="dropdown"
                                        href="#" aria-expanded="false" role="button"><i
                                            class="icon wb-more-vertical" aria-hidden="true"></i></a>
                                            ...
                                            <div class="media">
                                                <div class="pr-20">
                                                    <a class="avatar avatar-online" href="javascript:void(0)">
                                                        <img src="{{ asset('backend/global/portraits/9.jpg') }}"
                                                            alt="">
                                                        <i></i>
                                                    </a>
                                                </div>
                                                <div class="media-body w-full">
                                                    <div class="float-right">
                                                        <button type="button"
                                                            class="btn btn-outline btn-default btn-sm">Follow</button>
                                                    </div>
                                                    <div>
                                            ...
                                            <div class="media">
                                                <div class="pr-20">
                                                    <a class="avatar avatar-away" href="javascript:void(0)">
                                                        <img src="{{ asset('backend/global/portraits/10.jpg') }}"
                                                            alt="">
                                                        <i></i>
                                                    </a>
                                                </div>
                                                <div class="media-body w-full">
                                                    <div class="float-right">
                                                        <button type="button" class="btn btn-success btn-sm"><i
                                                                class="icon wb-check"
                                                                aria-hidden="true"></i>Following</button>
                                                    </div>
                                                    <div>
                                            ...
                                            <div class="media">
                                                <div class="pr-20">
                                                    <a class="avatar avatar-busy" href="javascript:void(0)">
                                                        <img src="{{ asset('backend/global/portraits/11.jpg') }}"
                                                            alt="">
                                                        <i></i>
                                                    </a>
                                                </div>
                                            ...
                                            <div class="media">
                                                <div class="pr-20">
                                                    <a class="avatar avatar-off" href="javascript:void(0)">
                                                        <img src="{{ asset('backend/global/portraits/12.jpg') }}"
                                                            alt="">
                                                        <i></i>
                                                    </a>
                                                </div>
                                    ...
                                    <div data-role="content">
                                            ...
                                            <small>Opened by
                                                <a class="hightlight" href="javascript:void(0)">
                                                    <span class="avatar avatar-xs">
                                                        <img src="{{ asset('backend/global/portraits/1.jpg') }}"
                                                            alt="">
                                                    </span>
                                        ...
                                        <li class="list-group-item justify-content-between">
                                            ...
                                            <small>Opened by
                                                <a class="hightlight" href="javascript:void(0)">
                                                    <span class="avatar avatar-xs">
                                                        <img src="{{ asset('backend/global/portraits/2.jpg') }}"
                                                            alt="">
                                                    </span>
                                        ...
                                        <li class="list-group-item justify-content-between">
                                            <small class="badge badge-round badge-primary float-right">In
                                                progress</small>
                                            <p>
                                            ...
                                            <small>Opened by
                                                <a class="hightlight" href="javascript:void(0)">
                                                    <span class="avatar avatar-xs">
                                                        <img src="{{ asset('backend/global/portraits/3.jpg') }}"
                                                            alt="">
                                                    </span>
                                        ...
                                        <li class="list-group-item justify-content-between">
                                            ...
                                            <small>Opened by
                                                <a class="hightlight" href="javascript:void(0)">
                                                    <span class="avatar avatar-xs">
                                                        <img src="{{ asset('backend/global/portraits/4.jpg') }}"
                                                            alt="">
                                                    </span>
                                                    <span>June Lane</span>
                                                </a>
                                        ...
                                        <li class="list-group-item justify-content-between">
                                            ...
                                            <small>Opened by
                                                <a class="hightlight" href="javascript:void(0)">
                                                    <span class="avatar avatar-xs">
                                                        <img src="{{ asset('backend/global/portraits/5.jpg') }}"
                                                            alt="">
                                                    </span>
                                                    <span>Herman Beck</span>
                                                </a>
                                        ...
                                        <li class="list-group-item justify-content-between">
                                            ...
                                            <small>Opened by
                                                <a class="hightlight" href="javascript:void(0)">
                                                    <span class="avatar avatar-xs">
                                                        <img src="{{ asset('backend/global/portraits/6.jpg') }}"
                                                            alt="">
                                                    </span>
                                                    <span>Mary Adams</span>
                                                </a>
                                        ...
                                        <li class="list-group-item justify-content-between">
                                            ...
                                            <small>Opened by
                                                <a class="hightlight" href="javascript:void(0)">
                                                    <span class="avatar avatar-xs">
                                                        <img src="{{ asset('backend/global/portraits/7.jpg') }}"
                                                            alt="">
                                                    </span>
                                                    <span>Caleb Richards</span>
                                                </a>
                                        ...
                                        <li class="list-group-item justify-content-between">
                                            ...
                                            <small>Opened by
                                                <a class="hightlight" href="javascript:void(0)">
                                                    <span class="avatar avatar-xs">
                                                        <img src="{{ asset('backend/global/portraits/8.jpg') }}"
                                                            alt="">
                                                    </span>
                                                    <span>June Lane</span>
                                                </a>
